...
#region Namespaces
namespace PingPong.Generator.Systems {} namespace PingPong.Generator.Components {} namespace PingPong.Generator.Modules {} namespace PingPong.Generator.Features {} namespace PingPong.Generator.Markers {} namespace PingPong.Generator.Views {}
#endregion

namespace PingPong.Generator {
    
    using TState = PingPongState;
    using PingPong.Modules;
    using ME.ECS;
    using ME.ECS.Views.Providers;
    using PingPong.Generator.Modules;
    ...
    public sealed class PingPongInitializer : InitializerBase {
